...
{
    public partial class CreateSalesInvoiceForm : BaseCrudForm<SalesInvoiceModel, SalesInvoiceDataManager>//BaseToolbarForm//
    {
        ...
        protected override void LoadForm(object sender, EventArgs e)
        {
            ...
            btnPrintDelivery2.Click += (o, args) =>
            {
                ...
                var branch = new BranchDataManager().GetFirst<BranchModel>(WhereTerm.Default(currentModel.BranchId, "id"));
        ...
        protected override SalesInvoiceModel PopulateModel(SalesInvoiceModel model)
        {
            ...
            model.TotalServiceTariff1 = (decimal) txtTotalCityCourier.Value;
