...
{
    public partial class InvoiceDelivery2PrintOut : InkJetPrintOut<SalesInvoiceModel.SalesInvoiceReportRow>//XtraReport//
    {
        public InvoiceDelivery2PrintOut()
        {
            InitializeComponent();
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            var total = GetCurrentColumnValue<Decimal>("Total");
            var numberSpelled = (PaymentReceiptPrintout.TerbilangHelper.Spell(total) + " rupiah").ToUpper();
            xrLabel26.Text = numberSpelled;
        }
        ...
        private void xrLabel24_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                int customerid = 0;
                Int32.TryParse(xrLabel12.Text, out customerid);
                var customer = customerDm.GetFirst<CustomerModel>(WhereTerm.Default(customerid, "id"));

                if (customer != null)
                {
                    xrLabel24.Text = customer.Code;
                }
            }
        }
        ...
        {
            //string datefrom = xrLabel15.Text ;
