    ...
    public class ReportParameter
    {
        ...
        public object Value
        {
            ...
            get
            {
                ...
                if (Control is dLookupC)
                {
                    return ((dLookupC)Control).Value;
                }
            ...
            set
            {
                ...
                else if (Control is dLookupC)
                {
                    ((dLookupC)Control).DefaultValue = new IListParameter[] { WhereTerm.Default(Convert.ToInt32(value), "id") };
                }
