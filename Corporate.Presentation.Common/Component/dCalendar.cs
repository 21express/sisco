...
namespace Corporate.Presentation.Common.Component
{
    ...
    {
        static dCalendar() { ComponentRepositories.DateEditCRepo.RegisterdCalendar(); }
        ...
        public override string EditorTypeName { get { return ComponentRepositories.DateEditCRepo.dCalendarNameF; } }

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new ComponentRepositories.DateEditCRepo Properties
        {
            get
            {
                return (ComponentRepositories.DateEditCRepo)base.Properties;
            }
        }
        ...
        {
            get { return ComponentRepositories.DateEditCRepo.FormatDateTimeF; }
            set { ComponentRepositories.DateEditCRepo.FormatDateTimeF = value; }
        }
