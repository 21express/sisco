...
namespace Corporate.Presentation.Common.Component
{
    ...
    {
        static dTime() { ComponentRepositories.TimeEditCRepo.RegisterdTime(); }
        ...
        public override string EditorTypeName { get { return ComponentRepositories.TimeEditCRepo.dTimeName; } }

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new ComponentRepositories.TimeEditCRepo Properties
        {
            get
            {
                return (ComponentRepositories.TimeEditCRepo)base.Properties;
            }
        }
        ...
        {
            get { return ComponentRepositories.TimeEditCRepo.FormatDateTime; }
            set { ComponentRepositories.TimeEditCRepo.FormatDateTime = value; }
        }
