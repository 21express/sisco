...
namespace Corporate.Presentation.Common.Component
{
    ...
    public partial class dLookupC : ButtonEdit, IValidatableComponent
    {
        ...
        static dLookupC() { ComponentRepositories.LookupCRepo.RegisterdLookupC(); }

        public override string EditorTypeName { get { return ComponentRepositories.LookupCRepo.dLookupName; } }
        ...
        // ReSharper disable once RedundantBaseConstructorCall
            : base()
        {
            ComponentRepositories.LookupCRepo.RegisterdLookupC();
                InitializeComponent();
                Init();
            }

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new ComponentRepositories.LookupCRepo Properties
        {
            get
            {
                return (ComponentRepositories.LookupCRepo)base.Properties;
            }
        }

        public dLookupC(IContainer container)
        {
            container.Add(this);
            InitializeComponent();
