...
{
    public class LookupCRepo : RepositoryItemButtonEdit
    {
        ...
        public LookupCRepo() : base() { }

        // ReSharper disable once InconsistentNaming
        internal const string dLookupName = "dLookupC";
        ...
        public static void RegisterdLookupC()
        {
            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(dLookupName, typeof(dLookupC),
               typeof(LookupCRepo), typeof(ButtonEditViewInfo), new ButtonEditPainter(), true, EditImageIndexes.LookUpEdit,
        ...
        protected override void OnLoaded()
        {
            ...
            {
                var dLookup = sender as dLookupC;
        ...
        public Action<string, dLookupC.AutoCompleteWhereExpressionParam> AutoCompleteWhereExpression { get; set; }
