...
{
    public partial class DeliveryOrderForm : BaseCrudForm<DeliveryOrderModel, DeliveryOrderDataManager>//BaseToolbarForm//
    {
        ...
        private void PrintPreview(object sender, EventArgs e)
        {
            ...
            if (nonCod.Count > 0)
            {
                var printNonCod = new DeliveryNonCODPrint();
                using (var printTool = new ReportPrintTool(printNonCod))
                {
                    printNonCod.DataSource = nonCod;
                    ...
                    printNonCod.RequestParameters = false;
                    printNonCod.Parameters.Add(new Parameter
                    {
                        Name = "Messenger",
        ...
        private void AddRow()
        {
            ...
            if (shipment == null)
            {
                var expand = new ShipmentExpandDataManager().GetFirst<ShipmentExpandModel>(WhereTerm.Default(tbxBarcode.Text, "fulfilment", EnumSqlOperator.Equals));
                if (expand != null)
                {
                    shipment = new ShipmentDataManager().GetFirst<ShipmentModel>(WhereTerm.Default(expand.ShipmentId, "id"));
                }
            }
            ...
            if (shipment != null)
            {
                ...
                {
                    if (shipment.BranchId == BaseControl.BranchId)
                    {
            ...
            else
            {
                ...
                MessageBox.Show("No. POD tidak dikenali");
            }
        ...
        {
            if (tbxDate.Text != "" && tbxCourier.Value != null && tbxKendaraan.Value != null)
                return true;
