...
{
    public partial class DataEntryCabangFilterPopup : BaseSearchCode<ShipmentModel, ShipmentDataManager>
    {
        ...
        public DataEntryCabangFilterPopup()
        {
            InitializeComponent();
