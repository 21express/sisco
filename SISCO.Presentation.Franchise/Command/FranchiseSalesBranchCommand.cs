...
{
    public class FranchiseSalesBranchCommand : IMenuInvoker
    {
        public void open()
        {
        ...
        public void open(Form parent)
        {
            ...
            var form = new ReportGenericFilterForm<object>
            {
                ...
                DataSourceFunc = parameters =>
                {
                    ...
                    param.Add(WhereTerm.Default(BaseControl.BranchId, "fs.branch_id", EnumSqlOperator.Equals));
