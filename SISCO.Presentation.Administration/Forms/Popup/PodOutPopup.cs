...
{
    public partial class PodOutPopup : BaseSearchCode<PodOutModel.PodOutLookupDataRow, PodOutDataManager>//BaseSearchPopup//
    {
        public PodOutPopup()
        {
            InitializeComponent();
        ...
        {
            return ((PodOutDataManager)DataManager).GetJoinShipment(paging, out count, parameters).Cast<T>();
        }
    }
}
