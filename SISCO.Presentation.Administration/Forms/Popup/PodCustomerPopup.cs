...
{
    public partial class PodCustomerPopup : BaseSearchCode<PodCustomerModel.PodCustomerLookupDataRow, PodCustomerDataManager>//BaseSearchPopup//
    {
        public PodCustomerPopup()
        {
            InitializeComponent();
            ...
            SearchView.Columns.AddRange(new[] { clCode, clStt, clDate });
        ...
        {
            return ((PodCustomerDataManager)DataManager).GetJoinShipment(paging, out count, parameters).Cast<T>();
        }
    }
}
