...
{
    public partial class ViewIncomingPodDetailForm : BaseCrudForm<ShipmentModel, ShipmentDataManager>//BaseToolbarForm//
    {
        ...
        public ViewIncomingPodDetailForm()
        {
            InitializeComponent();
            form = this;
        }
        ...
        private void btnAddStatus_Click()
        {
            ...
            if (chkPodReceived.Checked)
            {
                ((ShipmentModel)CurrentModel).PodReceived = 1;
            }
