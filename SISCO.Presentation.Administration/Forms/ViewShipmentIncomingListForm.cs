...
{
    public partial class ViewShipmentIncomingListForm : BaseMasterForm<ShipmentModel, ViewShipmentIncomingListForm.ShipmentDataRow2, ShipmentDataManager>//BaseForm//
    {
        ...
        public class ShipmentDataRow2 : ShipmentModel, INotifyPropertyChanged
        {
        ...
        public ViewShipmentIncomingListForm()
        {
            InitializeComponent();
            form = this;
            ...
            {
                var row = ConvertModel<ShipmentModel, ShipmentDataRow2>(model);
            ...
            DataManager.DefaultParameters = new IListParameter[] {WhereTerm.Default(BaseControl.BranchId, "dest_branch_id")};
        }
        ...
        protected override IListParameter[] Filter()
        {
            ...
            else
            {
                ...
                if (lkpOriginCity.Value != null) p.Add(WhereTerm.Default((int) lkpOriginCity.Value, "city_id"));
