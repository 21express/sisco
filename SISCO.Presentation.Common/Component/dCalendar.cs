...
namespace SISCO.Presentation.Common.Component
{
    ...
    {
        static dCalendar() { ComponentRepositories.DateEditRepo.RegisterdCalendar(); }
        ...
        public override string EditorTypeName { get { return ComponentRepositories.DateEditRepo.dCalendarName; } }

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new ComponentRepositories.DateEditRepo Properties
        {
            get
            {
                return (ComponentRepositories.DateEditRepo)base.Properties;
            }
        }
        ...
        {
            get { return ComponentRepositories.DateEditRepo.FormatDateTime; }
            set { ComponentRepositories.DateEditRepo.FormatDateTime = value; }
        }
