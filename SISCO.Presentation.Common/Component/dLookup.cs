...
namespace SISCO.Presentation.Common.Component
{
    ...
    public partial class dLookup : ButtonEdit, IValidatableComponent
    {
        ...
        static dLookup() { ComponentRepositories.LookupRepo.RegisterdLookup(); }

        public override string EditorTypeName { get { return ComponentRepositories.LookupRepo.dLookupName; } }
        ...
        // ReSharper disable once RedundantBaseConstructorCall
            : base()
        {
            ComponentRepositories.LookupRepo.RegisterdLookup();
                InitializeComponent();
                Init();
            }

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new ComponentRepositories.LookupRepo Properties
        {
            get
            {
                return (ComponentRepositories.LookupRepo)base.Properties;
            }
        }

        public dLookup(IContainer container)
        {
            container.Add(this);
            InitializeComponent();
