...
{
    public class LookupRepo : RepositoryItemButtonEdit
    {
        ...
        public LookupRepo() : base() { }

        // ReSharper disable once InconsistentNaming
        internal const string dLookupName = "dLookup";
        ...
        public static void RegisterdLookup()
        {
            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(dLookupName, typeof(dLookup),
               typeof(LookupRepo), typeof(ButtonEditViewInfo), new ButtonEditPainter(), true, EditImageIndexes.LookUpEdit,
        ...
        public Action<string, dLookup.AutoCompleteWhereExpressionParam> AutoCompleteWhereExpression { get; set; }
