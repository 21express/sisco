...
{
    public partial class InvoiceDistributionFilterPopup : BaseSearchCode<InvoiceDistributionResultModel, InvoiceDistributionResultDataManager>//BaseSearchPopup//
    {
        public InvoiceDistributionFilterPopup()
        {
            InitializeComponent();
        ...
        protected override void Filter(object sender, EventArgs e)
        {
            ...
            GridSearch.DataSource = new InvoiceDistributionResultDataManager().Search(BaseControl.BranchId, tbxCode.Text, tbxFrom.DateTime, tbxTo.DateTime);
