...
{
    public partial class InvoiceTransferAcceptanceFilterPopup : BaseSearchCode<InvoiceTransferAcceptanceModel, InvoiceTransferAcceptanceDataManager>//BaseSearchPopup//
    {
        public InvoiceTransferAcceptanceFilterPopup()
        {
            InitializeComponent();
        ...
        protected override void Filter(object sender, EventArgs e)
        {
            ...
            GridSearch.DataSource = new InvoiceTransferAcceptanceDataManager().Search(BaseControl.BranchId, tbxCode.Text, tbxFrom.DateTime, tbxTo.DateTime);
