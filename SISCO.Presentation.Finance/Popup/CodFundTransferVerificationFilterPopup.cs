...
{
    public partial class CodFundTransferVerificationFilterPopup : BaseSearchCode<CodFundTransferVerificationModel, CodFundTransferVerificationDataManager>//BaseSearchPopup//
    {
        public CodFundTransferVerificationFilterPopup()
        {
            InitializeComponent();
