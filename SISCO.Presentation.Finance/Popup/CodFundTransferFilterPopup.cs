...
{
    public partial class CodFundTransferFilterPopup : BaseSearchCode<CodFundTransferModel, CodFundTransferDataManager>//BaseSearchPopup//
    {
        public CodFundTransferFilterPopup()
        {
            InitializeComponent();
