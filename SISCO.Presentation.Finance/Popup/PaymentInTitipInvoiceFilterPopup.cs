...
{
    public partial class PaymentInTitipInvoiceFilterPopup : BaseSearchCode<OtherInvoicePaymentInModel, OtherInvoicePaymentInDataManager>
    {
        public PaymentInTitipInvoiceFilterPopup()
        {
            InitializeComponent();
        ...
        {
            var param = new List<WhereTerm>();
            var dm = new OtherInvoicePaymentInDetailDataManager();
