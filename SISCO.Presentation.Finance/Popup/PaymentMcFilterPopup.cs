...
{
    public partial class PaymentMcFilterPopup : BaseSearchCode<PaymentMcModel, PaymentMcDataManager>
    {
        public PaymentMcFilterPopup()
        {
            InitializeComponent();
            ...
            Load += PaymentMcFilterLoad;
        }

        private void PaymentMcFilterLoad(object sender, EventArgs e)
        {
            ...
            tbxMarketing.AutoCompleteWhereExpression +=
        ...
        protected override void BeforeFilter()
        {
            ...
            {
                param.Add(WhereTerm.Default((int) tbxMarketing.Value, "marketing_id", EnumSqlOperator.Equals));
                ParamEmpty = false;
            }
        ...
        {
            var param = new List<WhereTerm>();
            var dm = new PaymentMcDetailDataManager();
