...
{
    public partial class InvoiceAcceptanceFilterPopup : BaseSearchCode<SalesInvoiceAcceptanceModel, SalesInvoiceAcceptanceDataManager>//BaseSearchPopup//
    {
        public InvoiceAcceptanceFilterPopup()
        {
            InitializeComponent();
        ...
        protected override void Filter(object sender, EventArgs e)
        {
            ...
            GridSearch.DataSource = new SalesInvoiceAcceptanceDataManager().Search(BaseControl.BranchId, tbxCode.Text, tbxFrom.DateTime, tbxTo.DateTime);
