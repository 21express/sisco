...
{
    public partial class PaymentOutCollectInFilterPopup : BaseSearchCode<PaymentOutCollectInModel, PaymentOutCollectInDataManager>//BaseSearchPopup//
    {
        public PaymentOutCollectInFilterPopup()
        {
            InitializeComponent();
            ...
            SearchView.Columns.AddRange(new[] { clDate, clCode, clKw });
        ...
        {
            var param = new List<WhereTerm>();
            var dm = new PaymentOutCollectInDetailDataManager();
