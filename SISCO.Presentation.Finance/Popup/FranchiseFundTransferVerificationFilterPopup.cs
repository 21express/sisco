...
{
    public partial class FranchiseFundTransferVerificationFilterPopup : BaseSearchCode<FranchiseFundTransferVerificationModel, FranchiseFundTransferVerificationDataManager>//BaseSearchPopup//
    {
        public FranchiseFundTransferVerificationFilterPopup()
        {
            InitializeComponent();
