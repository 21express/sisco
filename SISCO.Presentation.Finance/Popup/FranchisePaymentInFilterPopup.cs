...
{
    public partial class FranchisePaymentInFilterPopup : BaseSearchCode<FranchisePaymentInModel, FranchisePaymentInDataManager>//BaseSearchPopup//
    {
        public FranchisePaymentInFilterPopup()
        {
            InitializeComponent();
