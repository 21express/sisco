...
{
    public partial class PaymentOutDeliveryFilterPopup : BaseSearchCode<PaymentDeliveryModel, PaymentDeliveryDataManager>
    {
        public PaymentOutDeliveryFilterPopup()
        {
            InitializeComponent();
        ...
        {
            var param = new List<WhereTerm>();
            var dm = new PaymentDeliveryDetailDataManager();
