...
{
    public partial class FranchiseFundTransferFilterPopup : BaseSearchCode<FranchiseFundTransferModel, FranchiseFundTransferDataManager>//BaseSearchPopup//
    {
        public FranchiseFundTransferFilterPopup()
        {
            InitializeComponent();
