...
{
    public partial class TitipInvoiceViewForm : BaseForm
    {
        public TitipInvoiceViewForm()
        {
            InitializeComponent();
            ...
            GridTitipInvoice.DoubleClick += (sender, args) => OpenRelatedForm(TitipInvoiceView, new TitipInvoiceForm());
        ...
        private void LoadGrid()
        {
            ...
            if (tbxDest.Value != null)
            {
                param.Add(WhereTerm.Default((int)tbxDest.Value, "branch_id", EnumSqlOperator.Equals));
            }
            ...
            if (chkLunas.Checked)
            {
                param.Add(WhereTerm.Default(true, "in_paid"));
                param.Add(WhereTerm.Default(true, "out_paid"));
            }
        ...
        private void TitipInvoiceListLoad(object sender, EventArgs e)
        {
            ...
            tbxDest.LookupPopup = new BranchPopup();
            tbxDest.AutoCompleteDataManager = new BranchDataManager();
            tbxDest.AutoCompleteDisplayFormater = model => ((BranchModel)model).Code + " - " + ((BranchModel)model).Name;
            tbxDest.AutoCompleteWhereExpression +=
