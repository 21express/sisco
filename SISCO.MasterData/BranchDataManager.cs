...
{
    public class BranchDataManager : BaseDataManager, IExtendedQueryableDataManager
    {
        ...
        {
            return ((BranchRepository)Repository).Get<T>(paging, out totalCount, expression, parameters);
        }
    }
}
