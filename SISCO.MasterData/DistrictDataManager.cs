...
{
    public class DistrictDataManager : BaseDataManager, IExtendedQueryableDataManager
    {
        ...
        {
            return ((DistrictRepository)Repository).Get<T>(paging, out count, expression, parameters);
        }
    }
}
