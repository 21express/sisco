...
namespace SISCO.Presentation.CounterCash.Print
{
    public partial class EConnotePrintout : InkJetPrintOut<ShipmentModel.ShipmentReportRow>//XtraReport//
    {
        ...
        private void xrLabel331_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void xrLabel332_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            var row = GetCurrentRow() as ShipmentModel.ShipmentReportRow;
            if (row.Printed > 0) ((XRLabel)sender).Text = string.Format("Copy {0}", row.Printed.ToString());
            else ((XRLabel)sender).Text = string.Empty;
        ...
        private void xrLabel333_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            var row = GetCurrentRow() as ShipmentModel.ShipmentReportRow;
            if (row.Printed > 0) ((XRLabel)sender).Text = string.Format("Copy {0}", row.Printed.ToString());
            else ((XRLabel)sender).Text = string.Empty;
        ...
        private void xrLabel334_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            var row = GetCurrentRow() as ShipmentModel.ShipmentReportRow;
            if (row.Printed > 0) ((XRLabel)sender).Text = string.Format("Copy {0}", row.Printed.ToString());
            else ((XRLabel)sender).Text = string.Empty;
        ...
        private void xrLabel335_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            var row = GetCurrentRow() as ShipmentModel.ShipmentReportRow;
            if (row.Printed > 0) ((XRLabel)sender).Text = string.Format("Copy {0}", row.Printed.ToString());
            else ((XRLabel)sender).Text = string.Empty;
