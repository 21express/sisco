...
{
    public partial class ManageDepartmentForm : BasePage, IGridChildForm
    {
        protected ExtendedBindingList<DepartmentModel> Items;
        protected List<DepartmentModel> DeletedItems;
        ...
        public ManageDepartmentForm()
        {
            ...
            DataManager = new DepartmentDataManager();
            Load += LoadForm;

            Items = new ExtendedBindingList<DepartmentModel>();
            DeletedItems = new List<DepartmentModel>();
            gridControl1.DataSource = Items;

            gridColumn1.Caption = @"Department";
            ...
            gridView1.Columns[0].RealColumnEdit.Validating += (sender, args) =>
            {
                ...
                {
                    args.Cancel = true;
                    MessageBox.Show(@"Department dengan nama yang sama sudah terdaftar");
                }
            };
        ...
        protected void RefreshGrid()
        {
            ...
            Items.Clear();
            BindListDataSource<DepartmentModel>().ForEach(row => Items.Add(row));
        ...
        public void Save()
        {
            ...
            ((DepartmentDataManager)DataManager).Save(Items, DeletedItems, BaseControl.UserLogin);
