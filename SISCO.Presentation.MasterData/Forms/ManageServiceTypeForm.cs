...
{
    public partial class ManageServiceTypeForm : BasePage, IGridChildForm
    {
        protected ExtendedBindingList<ServiceTypeModel> Items;
        protected List<ServiceTypeModel> DeletedItems;

        public ManageServiceTypeForm()
        {
            InitializeComponent();

            form = this;

            DataManager = new ServiceTypeDataManager();
            Load += LoadForm;

            Items = new ExtendedBindingList<ServiceTypeModel>();
            DeletedItems = new List<ServiceTypeModel>();
            gridControl1.DataSource = Items;

            gridColumn1.Caption = @"Service Type";
        ...
        protected void RefreshGrid()
        {
            ...
            Items.Clear();
            BindListDataSource<ServiceTypeModel>().ForEach(row => Items.Add(row));
        ...
        public void Save()
        {
            ...
            ((ServiceTypeDataManager)DataManager).Save(Items, DeletedItems, SISCO.Presentation.Common.BaseControl.UserLogin);
        ...
        {
            Items.Add(new ServiceTypeModel
            {
                Name = "",
                PricingCalcType = "",
                AdminFee = 0,
