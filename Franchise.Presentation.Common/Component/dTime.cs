...
namespace Franchise.Presentation.Common.Component
{
    ...
    {
        static dTime() { ComponentRepositories.TimeEditFRepo.RegisterdTime(); }
        ...
        public override string EditorTypeName { get { return ComponentRepositories.TimeEditFRepo.dTimeName; } }

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new ComponentRepositories.TimeEditFRepo Properties
        {
            get
            {
                return (ComponentRepositories.TimeEditFRepo)base.Properties;
            }
        }
        ...
        {
            get { return ComponentRepositories.TimeEditFRepo.FormatDateTime; }
            set { ComponentRepositories.TimeEditFRepo.FormatDateTime = value; }
        }
