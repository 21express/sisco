...
using Corporate.Presentation.CustomerService;
using Corporate.Presentation.DataEntry;
using Corporate.Presentation.MasterData;
...
namespace Corporate
{
    public partial class MainForm : Form
    {
        public MainForm()
        {
            ...
            miDataEntry.DropDownItems.AddRange(DataEntryMenu.GetMenus().ToArray());
            miDataEntry.DropDownItemClicked += ItemClick;
