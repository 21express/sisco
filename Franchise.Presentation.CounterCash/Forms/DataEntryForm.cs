...
{
    public partial class DataEntryForm : BaseCrudForm<ShipmentModel, ShipmentDataManager>//BaseToolbarForm//
    {
        ...
        protected override void LoadForm(object sender, EventArgs e)
        {
            ...
            rbLayout_Pdf.ItemClick += (o, args) =>
            {
                ...
                {
                    dialog.FileName = string.Format("{0}.pdf", tbxNo.Text);
        ...
        private bool CheckCn()
        {
            if (tbxNo.Text != "")
            {
                ...
                {
                    MessageBox.Show(Resources.cn_less_12, Resources.title_information, MessageBoxButtons.OK);
        ...
        protected override bool ValidateFormWithAlert()
        {
            if (tbxNo.Text == "")
            {
                MessageBox.Show(@"Please enter the POD number!");
                tbxNo.SelectAll();
                tbxNo.Focus();
                return false;
            }
        ...
        {
            if (tbxGlobalTotal.Value > 0) if (CheckCn()) base.Save();
