...
{
    public class VoidShipmentReportCommand : IMenuInvoker
    {
        public void open()
        {
        ...
        public void open(Form parent)
        {
            ...
            var form = new ReportGenericFilterForm<VoidShipmentReport.VoidCashReportDataRow>
            {
                MdiParent = parent,
                Text = @"Void Shipment Report",
                Report = new VoidShipmentReport(),
                ...
                DataSourceFunc = parameters =>
                {
                    ...
                    {
                        return repo.GetVoidList<VoidShipmentReport.VoidCashReportDataRow>(
                ...
                CustomTabularExportFormat = rows =>
                {
                    return rows;
                }
            };
