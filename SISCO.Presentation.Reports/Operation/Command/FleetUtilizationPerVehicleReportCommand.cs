...
{
    public class FleetUtilizationPerVehicleReportCommand : IMenuInvoker
    {
        public void open()
        {
        ...
        public void open(Form parent)
        {
            ...
            var form = new ReportGenericFilterForm<FleetUtilizationPerVehicleReport.FleetUtilizationPerVehicleReportDataRow>
            {
                MdiParent = parent,
                Text = @"Fleet Utilization Report",
                Report = new FleetUtilizationPerVehicleReport(),
                ...
                DataSourceFunc = parameters =>
                {
                    ...
                    {
                        return repo.GetFleetUtilizationPerVehicleReport<FleetUtilizationPerVehicleReport.FleetUtilizationPerVehicleReportDataRow>(
                ...
                OnLoad = (report, parameters) =>
                {
                    ...
                    ((FleetUtilizationPerVehicleReport)report).SetDetailVisibility((bool) parameters["ShowDetail"].Value);
                },
            };
