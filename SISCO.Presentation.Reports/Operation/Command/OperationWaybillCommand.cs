...
{
    public class OperationWaybillCommand : IMenuInvoker
    {
        public void open()
        {
        ...
        public void open(Form parent)
        {
            ...
            {
                MdiParent = parent,
                Text = @"Laporan Barang Via Darat",
                Report = new LaporanWaybillyReport(),
                ...
                {
                    using (var repo = new WaybillRepository())
                    {
