...
{
    public class UninvoicedSalesReportCommand : IMenuInvoker
    {
        public void open()
        {
        ...
        public void open(Form parent)
        {
            ...
            {
                MdiParent = parent,
                Text = @"Jurnal Penjualan per Customer (UNINVOICED)",
                Report = new UninvoicedSalesReport(),
                ...
                DataSourceFunc = parameters =>
                {
                    ...
                    {
                        return repo.GetUninvoicedSalesReport<ReportSalesJournal>(
