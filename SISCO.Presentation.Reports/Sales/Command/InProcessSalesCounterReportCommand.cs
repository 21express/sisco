...
{
    public class InProcessSalesCounterReportCommand : IMenuInvoker
    {
        public void open()
        {
        ...
        public void open(Form parent)
        {
            ...
            {
                MdiParent = parent,
                Text = @"Jurnal Penjualan per Customer (IN-PROCESS)",
                Report = new InProcessSalesCounterReport(),
                ...
                DataSourceFunc = parameters =>
                {
                    ...
                    {
                        return repo.GetInprocessSalesCounter<ReportSalesJournal>(
