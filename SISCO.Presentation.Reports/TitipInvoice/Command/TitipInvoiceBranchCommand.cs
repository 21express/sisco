...
namespace SISCO.Presentation.Reports.TitipInvoice.Command
{
    ...
    public class TitipInvoiceBranchCommand : IMenuInvoker
    {
        public void open()
        {
        ...
        public void open(Form parent)
        {
            ...
            {
                MdiParent = parent,
                Text = @"Titip Invoice - Branch",
                Report = new TitipInvoiceBranchReport(),
                ...
                DataSourceFunc = parameters =>
                {
                    ...
                    var ds = new OtherInvoiceRepository().ReportJournalCustomer(param.ToArray(), asofDate);
