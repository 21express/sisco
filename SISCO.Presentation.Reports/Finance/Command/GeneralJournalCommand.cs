...
{
    public class GeneralJournalCommand : IMenuInvoker
    {
        public void open()
        {
        ...
        public void open(Form parent)
        {
            ...
            {
                MdiParent = parent,
                Text = @"Finance - Buku Bank",
                Report = new GeneralJournalReport(),
                ...
                DataSourceFunc = parameters =>
                {
                    ...
                    return new TransactionalAccountRepository().JournalReport((int)account, fdate, tdate);
                }
            };
