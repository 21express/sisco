...
{
    public class OutstandingInvoicesReportCommand : IMenuInvoker
    {
        public void open()
        {
        ...
        public void open(Form parent)
        {
            ...
            var form = new ReportGenericFilterForm<SalesInvoicePaymentReportModel>
            {
                ...
                Report = new OutstandingInvoicesReport(),
                ...
                OnLoad = (report, parameters) =>
                {
                    ...
                    ((OutstandingInvoicesReport)report).SetDetailVisibility((bool) parameters["ShowDetail"].Value);
                },
            };
