...
{
    public partial class PickupPopup : BaseSearchCode<FranchisePickupModel, FranchisePickupDataManager>//BaseSearchPopup//
    {
        public PickupPopup()
        {
            InitializeComponent();
            ...
            Load += OnLoad;
            DataManager.DefaultParameters = new IListParameter[] { WhereTerm.Default(BaseControl.FranchiseId, "franchise_id", EnumSqlOperator.Equals) };
        }
